...
INSERT INTO users (user_id, user_name, user_email, auth_id, auth_picture, user_bg, color, theme)
VALUES ('Taryn Ficklin', 'clayf700@gmail.com', 'google-oauth2|115352869833705350314', 'https://lh4.googleusercontent.com/-WtSvKjFYiXM/AAAAAAAAAAI/AAAAAAAAAHc/fXzUoy8H42A/photo.jpg', 'http://unsplash.com', '#CCC', 'light');

INSERT INTO users (user_id, user_name, user_email, auth_id, auth_picture, user_bg, color, theme)
VALUES ('TarynFicklin@gmail.com', 'TarynFicklin@gmail.com', 'github|38847691', 'https://avatars2.githubusercontent.com/u/38847691?v=4', 'http://unsplash.com', '#CCC', 'light');

INSERT INTO users (user_id, user_name, user_email, auth_id, auth_picture, user_bg, color, theme)
VALUES ('Taryn Ficklin', 'clayf700@gmail.com', 'facebook|1346171328848139', 'https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=1346171328848139&height=50&width=50&ext=1536190305&hash=AeTPNLQ9xlGCTpxU', 'http://unsplash.com', '#CCC', 'light');
